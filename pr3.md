...
```python
#jyaare division hoi tyaare float j answer aavse
print(10/(1*3/6))
```
...
```python
10 and 5#if x is false then ans is x,x should be 0 or empty
```
...
```python
print(True or 5)#if x is true then answer is x
```
...
```python
print(False or 5)#if x is false then answer is y
```
...
```
    ...
    <ipython-input-12-01a2217119a3> in <module>
    ----> 1 print(3/0)
...
```python
print(5 and True or 3/0)#aama true aave chhe last ma atle te pachal ni error jose j nai
```
...
```
    ...
    <ipython-input-14-14534561d8cd> in <module>
    ----> 1 print(5 and True and 3/0)
...
```
    ...
    <ipython-input-22-e89850539451> in <module>
    ----> 1 print(7 and 0 or 5 and 3 and 7/0)
